        ...
        <div>
            ...
            <div className='flex items-center justify-center gap-5'>
                <div className='w-[70%]'>
                    ...
                    <ProtectionPart></ProtectionPart>
                    <BillingAddress></BillingAddress>
                    <PaymentPart></PaymentPart>
                </div>
                <div className='w-[30%]'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus est minima non modi, nemo explicabo veniam incidunt officia. Quod, porro reiciendis architecto omnis animi facere laboriosam, ipsum perspiciatis amet at odio, voluptatibus nemo veritatis tempore velit aliquam cum cumque. Amet maiores suscipit provident exercitationem fuga animi sapiente temporibus id tenetur error illum nihil at debitis, quia quisquam ipsum soluta, earum ipsa rerum odit quos beatae labore adipisci blanditiis? Delectus at illo qui. Officia commodi libero molestias minima dolores. Ea necessitatibus quisquam enim veniam cupiditate voluptate, corrupti quos libero? Voluptatem soluta aperiam exercitationem quasi asperiores ullam doloribus quis voluptates numquam sed!
                </div>
            </div>
        </div>
    )
